...
function OthrBenefits() {
    return (
        <div><div className='container mx-auto p-auto md:p-5'>
            <div className="flex flex-col md:flex-row items-center justify-center gap-5 bg-gray-100 p-6">
                ...
                <div className="lg:w-1/2  mb-6 lg:mb-0">
                    <img
                        ...
                        alt="Navy dock scene"
                        className="  object-cover rounded-lg shadow-lg  w-fit object-center h-[500px]"
                    />
                </div>
            </div>
        </div></div>
